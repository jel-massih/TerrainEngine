...
{
	if(!SetShaderParamaters(deviceContext, worldMatrix, viewMatrix, projectionMatrix))
	{
		return false;
	}
...
bool ColorShaderClass::SetShaderParamaters(ID3D11DeviceContext* deviceContext, XMMATRIX& worldMatrix, XMMATRIX& viewMatrix, XMMATRIX& projectionMatix)
{
	HRESULT result;
